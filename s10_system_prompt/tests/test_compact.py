...
import pytest
from s10_system_prompt.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s10_system_prompt.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s10_system_prompt.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
