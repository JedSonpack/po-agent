...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s08_context_compact.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s08_context_compact.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
