...
import pytest
from s20_comprehensive.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s20_comprehensive.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s20_comprehensive.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
