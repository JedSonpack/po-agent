...
import pytest
from s16_team_protocols.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s16_team_protocols.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s16_team_protocols.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
