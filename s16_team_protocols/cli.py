...
from s16_team_protocols.config import load
from s16_team_protocols.tools import TOOL_HANDLERS, SUB_HANDLERS, TEAM_HANDLERS, make_run_tool
from s16_team_protocols.hooks import trigger_hooks, register_defaults
from s16_team_protocols.todo import TodoNag
from s16_team_protocols.subagent import Subagent
...
def main() -> None:
    ...
    print("s16: Team Protocols — request-response handshake")
