...
import pytest
from s12_task_system.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s12_task_system.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s12_task_system.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
