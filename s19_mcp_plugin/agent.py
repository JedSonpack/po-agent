"""核心 agent 循环（s19）：s18 + MCP（tool_pool 动态工具池）。"""
from typing import Callable

from s19_mcp_plugin.system_prompt import build_context, get_system_prompt
from s19_mcp_plugin.recovery import (RecoveryState, with_retry, is_prompt_too_long_error,
                                           DEFAULT_MAX_TOKENS, ESCALATED_MAX_TOKENS,
                                           MAX_RECOVERY_RETRIES, CONTINUATION_PROMPT)
from s19_mcp_plugin.background import (should_run_background, start_background_task,
                                             collect_background_results)
from s19_mcp_plugin.cron import consume_cron_queue
