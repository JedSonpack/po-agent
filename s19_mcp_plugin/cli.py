...
from s19_mcp_plugin.agent import agent_loop
from s19_mcp_plugin.config import load
from s19_mcp_plugin.tools import TOOL_HANDLERS, SUB_HANDLERS, TEAM_HANDLERS, make_run_tool
from s19_mcp_plugin.hooks import trigger_hooks, register_defaults
from s19_mcp_plugin.todo import TodoNag
from s19_mcp_plugin.subagent import Subagent
from s19_mcp_plugin.compact import Compactor
from s19_mcp_plugin.memory import Memory
...
def main() -> None:
    ...
    print("s19: MCP Plugin — external tools via standard protocol")
