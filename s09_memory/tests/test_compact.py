...
import pytest
from s09_memory.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s09_memory.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s09_memory.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
