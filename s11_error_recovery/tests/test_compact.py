...
import pytest
from s11_error_recovery.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s11_error_recovery.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s11_error_recovery.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
