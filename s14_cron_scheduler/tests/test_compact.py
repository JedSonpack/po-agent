...
import pytest
from s14_cron_scheduler.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s14_cron_scheduler.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s14_cron_scheduler.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
