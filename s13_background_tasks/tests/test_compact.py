...
import pytest
from s13_background_tasks.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s13_background_tasks.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s13_background_tasks.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
