...
import pytest
from s18_worktree_isolation.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s18_worktree_isolation.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s18_worktree_isolation.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
