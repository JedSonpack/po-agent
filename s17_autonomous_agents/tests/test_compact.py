...
import pytest
from s17_autonomous_agents.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s17_autonomous_agents.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s17_autonomous_agents.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
