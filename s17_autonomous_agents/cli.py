...
from s17_autonomous_agents.agent import agent_loop
from s17_autonomous_agents.config import load
from s17_autonomous_agents.tools import TOOL_HANDLERS, SUB_HANDLERS, TEAM_HANDLERS, make_run_tool
from s17_autonomous_agents.hooks import trigger_hooks, register_defaults
from s17_autonomous_agents.todo import TodoNag
from s17_autonomous_agents.subagent import Subagent
from s17_autonomous_agents.compact import Compactor
from s17_autonomous_agents.memory import Memory
from s17_autonomous_agents.cron import start_scheduler, agent_lock
from s17_autonomous_agents.teams import Team, BUS, active_teammates, consume_lead_inbox
from s17_autonomous_agents.background import has_pending_background, collect_background_results
...
def main() -> None:
    ...
    print("s17: Autonomous Agents — self-claim idle loop")
