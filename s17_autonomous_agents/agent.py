"""核心 agent 循环（s17）：s16 + 自治（agent_loop 不变；自治在 Team idle_poll）。"""
from typing import Callable

from s17_autonomous_agents.system_prompt import build_context, get_system_prompt
from s17_autonomous_agents.recovery import (RecoveryState, with_retry, is_prompt_too_long_error,
                                           DEFAULT_MAX_TOKENS, ESCALATED_MAX_TOKENS,
                                           MAX_RECOVERY_RETRIES, CONTINUATION_PROMPT)
from s17_autonomous_agents.background import (should_run_background, start_background_task,
                                             collect_background_results)
from s17_autonomous_agents.cron import consume_cron_queue
