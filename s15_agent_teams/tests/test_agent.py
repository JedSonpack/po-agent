...
from s15_agent_teams.system_prompt import reset_cache
...
def _reset():
    from s15_agent_teams import background, cron
    reset_cache()
...
def test_cron_queue_injected_as_scheduled():
    from s15_agent_teams import cron
    from s15_agent_teams.cron import CronJob
