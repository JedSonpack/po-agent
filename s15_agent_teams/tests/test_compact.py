...
import pytest
from s15_agent_teams.compact import (
...
def test_run_pipeline_runs_all_three(compactor, monkeypatch):
    ...
    monkeypatch.setattr("s15_agent_teams.compact.snip_compact", lambda m, *a, **k: calls.append("snip") or m)
    monkeypatch.setattr("s15_agent_teams.compact.micro_compact", lambda m, *a, **k: calls.append("micro"))
